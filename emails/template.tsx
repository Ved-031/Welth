...
export default function EmailTemplate({ username = "", type = "monthly-report", data = {} }: EmailProps) {
            ...
            <Html>
                ...
                <Body style={styles.body}>
                    <Container style={styles.container}>
                        ...
                        <Text style={styles.text}>
                            You&lsquo;ve used {parseFloat(data?.percentageUsed).toFixed(2)}% of your monthly budget.
                        </Text>
                        <Section style={styles.statsContainer}>
                            <div style={styles.stat}>
