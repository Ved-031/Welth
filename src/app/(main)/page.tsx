...
import { featuresData, howItWorksData, statsData, testimonialsData } from "@/lib/data";
        ...
        <div className="mt-40">
                ...
                <div className="container mx-auto px-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {howItWorksData.map((item, index) => (
                            <div key={index} className="text-center">
                                <div className="size-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">{item.icon}</div>
            ...
            <section className="py-20 bg-blue-600">
                <div className="container mx-auto px-10 text-center">
                    ...
                    <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands of happy users who are already managing their finances smarter with Welth.</p>
                    <Link href="/dashboard">
